...
Thank you for considering contributing to Markup+.

Every contribution matters: bug reports, documentation fixes, new
features, translations, or just spreading the word. This guide will
...
may be reported by opening an issue or contacting the maintainers
directly at hosseinataee2009@gmail.com.
...
You do not need to write code to contribute. Here is how:

### Report Bugs

Found something broken? Open an issue with the bug report template.

### Suggest Features

Have an idea? Start a discussion with the feature request template.
...
More tests means more confidence. Even one test helps.
...
Experienced contributors should look for:
...
Go to https://github.com/ataee-dev/markup-plus and click Fork.
...
### Step 3: Add Upstream Remote
    ...
    git remote add upstream https://github.com/ataee-dev/markup-plus.git
    git remote -v
...
You should see:
    ...
    upstream  https://github.com/ataee-dev/markup-plus.git (fetch)
    upstream  https://github.com/ataee-dev/markup-plus.git (push)
...
All tests should pass. If not, open an issue.
...
Go to your fork on GitHub. You will see a banner: Compare and pull
request.

Click it and follow the Pull Request Process.
...
Aim for 80 percent or higher coverage. Check with:
...
Use clear, active voice:
    ...
    Wrong:  The file is converted by running mup.
    Right:  Run `mup` to convert the file.
...
- Write "Fixed bug" (not descriptive)
- Write "Update" (too vague)
- Write "WIP" (do not commit WIP)
...
3. Feedback -- you may be asked to change things
...
- Do not take it personally -- it is about the code
...
2. Leave a comment asking for review
3. If no response in 2 weeks, ping again
...
### Feature Request Template
    ...
    **Is your feature request related to a problem?**
    ...
    Yes -- I am always frustrated when I have to...
    ...
    **Describe alternatives you have considered**
    ...
    I could embed with HTML iframe, but that is ugly.
...
For big features, we will discuss:
...
- Be accurate -- do not just use machine translation
- Keep technical terms -- "parser" stays "parser"
- Match tone -- formal or informal consistent
...
Whether you fixed a typo, reported a bug, added a feature, or just
told a friend about us -- thank you.
